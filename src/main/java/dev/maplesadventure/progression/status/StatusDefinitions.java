...
public final class StatusDefinitions extends SimpleJsonResourceReloadListener {
    ...
    public static StatusEffectDefinition parse(StatusEffectType type, JsonObject json) {
        fields(json, Set.of("decay_delay", "decay_per_second", "active_duration", "tick_interval", "damage", "damage_taken_multiplier", "stamina_regen_multiplier"));
        ...
        if ((type == StatusEffectType.BLEED) != (duration == 0)) throw new IllegalArgumentException("Bleed is instant; other statuses require duration");
        return new StatusEffectDefinition(integer(json,"decay_delay",d.decayDelay()), number(json,"decay_per_second",d.decayPerSecond()),
                ...
                number(json,"stamina_regen_multiplier",d.staminaRegenMultiplier()));
    }
